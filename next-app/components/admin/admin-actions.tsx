...
export interface AdminAction {
    ...
    quickCreate?: 'product' | 'logo' | 'company' | 'station' | 'order';
}

export const ADMIN_ACTIONS: AdminAction[] = [
    { id: 'new-order', label: 'Nuevo pedido', href: '/catalog', Icon: ShoppingCart, primary: true, quickCreate: 'order' },
    ...
    { id: 'new-company', label: 'Nueva empresa', href: '/admin/companies', Icon: Building2, quickCreate: 'company' },
    { id: 'new-logo', label: 'Nuevo logo', href: '/admin/logos', Icon: Sticker, quickCreate: 'logo' },
    { id: 'new-station', label: 'Nueva estación', href: '/admin/station-users', Icon: HardHat, quickCreate: 'station' },
